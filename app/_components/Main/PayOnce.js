        ...
        <div className="w-full mx-auto px-4 mt-[100px] mdx:mt-[150px] bg-[#F1F4F8] ">
            <div className=" max-w-[1440px] mx-auto py-[60px] mdx:py-[80px] xl:py-[100px] ">
                <div className="max-w-[1054px]">
                    ...
                    <h2 className="text-[#3FAEFF] mt-[3px] text-[30px] mdx:text-[35px] lh mdl:text-[40px] slg:text-[45px] xl:text-[50px] font-bold">Оплатите за один прием и получите полноценное наблюдение через Telegram и личные встречи в течении месяца</h2>
