  ...
  useEffect(() => {
    const handleResize = () => {
      const updatedReviews = reviews.map((review) => {
        const maxLength = window.innerWidth >= 1000 ? 57 : 69;
        return {
          ...review,
          description:
  ...
  return (
    <div className="w-full max-w-[1440px] px-[15px] mx-auto mt-[100px] mdx:mt-[120px] xl:mt-[170px] mb-[100px] mdx:mb-[120px] xl:mb-[170px]">
      ...
      <div className="grid grid-cols-1 mdx:grid-cols-2 xl:grid-cols-4 gap-5 mt-7">
        {trimmedReviews.map((review, index) => (
          <div key={index} className="border p-4 rounded-xl ">
            ...
            <p className="text-[14px] mdl:text-[18px] text-[#737373] mt-2 lh">
              {review.description}
            </p>
            <a href="https://t.me/endo_krinolog" target="_blank" className="flex items-center mt-4">
      ...
      <Link href={'/blog'} >
        <div className="text-center mt-8">
          <button className="text-[16px] rounded-xl mdx:text-[20px] font-bold text-[#3FAEFF] border border-[#3FAEFF] px-[74px] py-[12px]">
            Все статьи
          </button>
        </div>
      </Link>
